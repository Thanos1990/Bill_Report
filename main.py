...
class PdfReport:
    ...
    def generate(self, flatmate1, flatmate2, bill):
        ...
        # Add icon
        pdf.image(r"C:\Users\thana\OneDrive\Documents\Udemy\Python_OOP\App_2\house.png", w=30, h=30)
...
the_bill = Bill(amount=120,period="August 2024")
...
pdf_report = PdfReport(filename=r"C:\Users\thana\OneDrive\Documents\Udemy\Python_OOP\App_2\bill.pdf")
